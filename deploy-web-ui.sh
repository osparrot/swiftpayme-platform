...
# SwiftPayMe Web UI Deployment Script
# This script builds and serves the Web UI without Docker

set -e

echo "🚀 Starting SwiftPayMe Web UI Deployment..."

# Navigate to Web UI directory
cd /home/ubuntu/swiftpayme/web-ui
...
echo "🌐 To start the server, run: node serve.js"
